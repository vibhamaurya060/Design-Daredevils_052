...
import { Home, DollarSign, Layers, User, Tag, MapPin } from 'lucide-react'; 
...
const Dashboard = ({ properties = [] }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      <div className="p-6">
        <h2 className="text-2xl font-bold mb-6 mt-8 text-gray-800 text-center">Dashboard Overview</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-blue-50 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-700">Total Properties</h3>
            <p className="text-lg font-semibold text-blue-600">{properties.length}</p>
          </div>
          ...
          <div className="bg-green-50 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-700">Total Value</h3>
            <p className="text-lg font-semibold text-green-600">₹{totalValue.toLocaleString()}</p>
          </div>

          {/* Property Types */}
          <div className="bg-purple-50 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            <Layers className="text-purple-600 w-8 h-8 mb-4" />
            <h3 className="text-xl font-bold text-gray-700">Property Types</h3>
            <p className="text-base text-gray-600">{propertyTypes}</p>
          </div>
          ...
          <div className="bg-orange-50 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            <Tag className="text-orange-600 w-8 h-8 mb-4" />
            <h3 className="text-xl font-bold text-gray-700">Most Expensive Property</h3>
            <p className="text-base text-gray-600">{mostExpensive.title || 'N/A'}</p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            ...
            <ul className="space-y-2 text-center">
              {recentProperties.map((prop) => (
                <li key={prop.id} className="text-base text-gray-700">
          ...
          {/* Properties by City */}
          <div className="bg-teal-50 p-6 rounded-lg shadow-md col-span-1 sm:col-span-2 lg:col-span-3">
            <MapPin className="text-teal-600 w-8 h-8 mb-4 mx-auto" />
            <h3 className="text-2xl font-bold text-gray-700 text-center mb-4">Properties by City</h3>
